"""MasKIT — parsing raw output + type inference pro placeholdery.

MasKIT vrací text ve formátu "placeholder_[original]". Tento modul parsuje
raw output, vytahuje (placeholder, original) páry a klasifikuje typ entity
přes vícevrstvý fallback.
"""
...
def parse_maskit(result: str) -> tuple[str, list[dict[str, Any]]]:
    ...
    Vrací: (anonymized_text, list_of_replacements)
    Každá replacement obsahuje original, placeholder + _raw_context_before.
    """
